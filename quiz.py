...
# Define a method to handle an invalid password
   ...
   def log_out(self):
    ...
    # Method to set up the registration window
   def register(self):
       ...
       # Method to verify passwords and register a user, checking if the passwords meet the requirements
   def register_user(self, registering_window):
    ...
    #Verify if the passwords match before registering the user
...
# This will simply be used to close the application
   def close_application(self):
        print("Closing application")
        self.master.quit()
        self.master.destroy()

    # This method will allow students to create, edit or delete a quiz, setting up the foundation for the action choice
   def manage_quizzes(self):
        ...
        #This is where the user will be able to create their own quiz, it handles both the GUI and the database
   def create_new_quiz(self):
    ...
    #First checks if all fields are filled in, then saves the quiz to the database
   def save_new_quiz(self):
    ...
    # This method will be used to fetch the quiz details and questions from the database, for editing a quiz
   def fetch_quiz_data(self, quiz_id):
    ...
    #Making sure that a quiz they own is selected before editing
   def edit_selected_quiz(self):
    ...
    if not selected_title:
        ...
        return
    #Rare case where the selected quiz title is not in the map
    ...
    #Similar to create_new_quiz, but this time it will be used to edit a quiz, having all the fields pre-filled
   def create_edit_quiz_window(self, quiz_data, quiz_id):
    ...
    #This method will be used to save the updated quiz to the database, using UPDATE queries instead of INSERT
   def save_updated_quiz(self):
    ...
    #This method will be used to delete a quiz from the database, using DELETE queries
   def delete_selected_quiz(self):
    ...
    #This is the foundation for listing quizzes in a dropdown menu
   ...
   # This is where users can choose which quizzes they get quizzed on
   def assignments(self):
    ...
    # This method will be used to start a selected custom quiz
   ...
   def start_quiz(self, quiz_id):
        ...
        #This is where the question and answers are displayed, alongside the submit and back buttons
   def load_question(self, question_index):
    ...
    # This method will be used to navigate back to the previous question, using a stack to keep track of the previous questions
   def go_back(self): 
    # The line below is necessary as there shouldn't be a back button on the first question
   ...
   def submit(self):
    ...
    # This method will be used to finalize the quiz, calculate the total score and insert it into the scores table, associated with the quiz name and user_id for analytical purposes
   ...
   # Define a method to display the final score
   ...
   def summary(self):
    ...
    # User shouldn't be able to access analytics if they don't have any scores associated with them
    ...
    #Dropdown menu to allow students to sort their scores in ascending/descending order using merge_sort(see below)
    ...
    #Button to allow users to delete their stats, which opens a confirmation dialog
   ...
   def confirm_delete(self):
    ...
    if response:
        ...
        #If selected yes, this method will delete all stats associated with the user_id
   def delete_all_stats(self):
    ...
    #Sort the scores dynamically based on the user's choice
   ...
   def merge_sort(self, scores, ascending=True):
    ...
    return scores
        ...
        #This method is used to display all the stats, alongside a bar graph
   ...
   # Method to display a bar graph of scores
